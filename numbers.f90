module numbers
  ...
  double precision, parameter:: Mu1_DEFAULT = 0.211D0, Md1_DEFAULT = 0.210D0, MS1_DEFAULT = 0.211D0, mg1_default = 0.05D0
  double precision, parameter:: Mu2_DEFAULT = 0.100D0, Md2_DEFAULT = 0.100D0, MS2_DEFAULT = 0.100D0, mg2_default = 0.05D0
  double precision, parameter:: Mu3_DEFAULT = 0.301D0, Md3_DEFAULT = 0.301D0, MS3_DEFAULT = 0.301D0, mg3_default = 0.05D0
  double precision, parameter:: Mu4_DEFAULT = 0.211D0, Md4_DEFAULT = 0.210D0, MS4_DEFAULT = 0.211D0, mg4_default = 0.05D0
  double precision, parameter:: M3t5_DEFAULT = 0.00D0
  double precision, parameter:: kappat1 = 120.0d0, kappal1 = 120.0d0, kappat3 = 0.0d0, kappal3 = 0.0d0
