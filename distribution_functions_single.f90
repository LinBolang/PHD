...
!!!!!!!!test the normalization for d quark. and the normalization should be equal to 1 !!!!!!!!
    ...
    loopnumber_loc=0
        ...
        do test=1,loopnumber_loc
            ...
            print*, "Form Factor for u quark", distributionfunctions_FF(2,test),distributionfunctions_FF(3,test),&
            & distributionfunctions_FF(4,test)
        ...
        do test=1,loopnumber_loc
            ...
            print*, "Form Factor for s quark", distributionfunctions_FF(2,test),distributionfunctions_FF(3,test),&
            & distributionfunctions_FF(4,test)
